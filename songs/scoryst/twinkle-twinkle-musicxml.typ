...
// See ../musicxml/twinkle-twinkle.musicxml for a heavily annotated walk-through of the
// MusicXML structure.
...
// XML and drawn here instead (see the note in ../musicxml/twinkle-twinkle.musicxml).
...
// on two systems.
#score(
  read("../musicxml/twinkle-twinkle.musicxml"),
