...
// scoryst-free counterpart of songs/scoryst/four-voices-exploded-bass.typ.
#align(center, text(weight: "bold", size: 16pt)[Twinkle, Twinkle, Little Star])
#align(center, text(size: 10pt, style: "italic")[SATB, Bass highlighted])
#v(12pt)

#let prefix = "/songs/musicxml-svg/four-voices-exploded-bass"
